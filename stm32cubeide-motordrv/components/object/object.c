...
enum object_info_type
{
  ...
  Object_Info_Protect_Structure = 3,
  Object_Info_Bracket = 4,
  Object_Info_Lens = 5,
...
static struct object_information object_container[Object_Info_Unknown] =
    {
        ...
        /* initialize object container - Controller */
        {Object_Class_Protect_Structure, _OBJ_CONTAINER_LIST_INIT(Object_Info_Protect_Structure)},
        /* initialize object container - Controller */
        {Object_Class_Bracket, _OBJ_CONTAINER_LIST_INIT(Object_Info_Bracket)},
        /* initialize object container - Controller */
