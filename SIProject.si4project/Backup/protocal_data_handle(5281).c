...
static uint8_t modbus_rx_buffer[MODBUS_RX_BUF_SIZE];
static fifo_s_t  fifo_modbus_rx;
//an container object to help unpack plain data.
static ModBus_UnPack_Helper UnPackHelper;
uint32_t crc32_tab[] =
{
...
void pdh_param_init(void)
{
	...
	fifo_s_init(&fifo_modbus_rx,modbus_rx_buffer,MODBUS_RX_BUF_SIZE):

	//initial ModBus UnPack Helper.
