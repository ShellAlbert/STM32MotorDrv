...
void pdh_param_init(void)
{
	...
	fifo_s_init(&g_ModBusRxFIFO, g_ModBusRxBuffer, MODBUS_RX_BUF_SIZE): //initial ModBus UnPack Helper.
		...
		switch (g_UnPackHelper.fsm)
			...
			case UnPack_Field_Sync:
					...
					if (SYNC_HEADER_CLEAR == uRxInt32)
						...
						memcpy((void *) crc32_buffer, (void *) &uRxInt32, sizeof(uRxInt32));
			...
			case UnPack_Field_RegData:
					{
					g_UnPackHelper.regDataField = uRxInt32;
			...
			case UnPack_Field_CRC32:
					...
					if (uRxInt32 == crc32(crc32_buffer, crc32_buffer_len))
						{
